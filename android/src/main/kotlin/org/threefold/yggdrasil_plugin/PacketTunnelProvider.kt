...
class PacketTunnelProvider: VpnService() {
    ...
    override fun onCreate() {
        Log.d("ygg", "Tunnelservice created  ");
        super.onCreate()
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.d("ygg", "Got a start command ");
        Log.d("ygg", "Got a start command " + intent!!.action)


        

        Log.d("BML-TUNNEL", "" + System.identityHashCode(LocalBroadcastManager.getInstance(this)));
        if (intent == null) {
    ...
    private fun start() {
        ...
        Log.d("PacketTunnelProvider", "BROADCAST")
